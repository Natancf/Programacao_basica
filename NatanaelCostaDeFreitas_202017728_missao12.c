...
Time cadastrarTime(Time *time); //Função para cadadastrar time
...
void listarPartida(Partida partida[], int *ptrquantPartidas, int totalPontosPorJogador[], Time *time); //Função para listar as partida
    ...
    do
    {
        ...
        case 5:
            do
            {
                ...
                printf("+-----------------------------------------------------+\n");
                listarPartida(partida, ptrquantPartidas, totalPontosPorJogador, time); //Função para listar partidas
                printf("+-----------------------------------------------------+\n");
...
void listarPartida(Partida partida[], int *ptrquantPartidas, int totalPontosPorJogador[], Time *time) //Função lista as partidas
{
    int maior = 0;
    for (int i = 0; i < *ptrquantPartidas; i++)
    {
